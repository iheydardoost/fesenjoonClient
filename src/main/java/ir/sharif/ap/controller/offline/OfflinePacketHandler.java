...
public class OfflinePacketHandler {

    public OfflinePacketHandler() {
    }
    ...
    public String makePacketStr(OfflinePacket packet){
    ...
    public OfflinePacket parsePacket(String str, int clientID){
        ...
        return new OfflinePacket(myPacketType,myBody,myAuthToken,myAuthTokenAvailable,clientID,myRequestID);
    }
}
